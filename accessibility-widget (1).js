(function () {
  ...
  if (isInIframe) {
    document.body.classList.add('acc-in-iframe');
    // Position toggle at bottom-right
    // When panel opens, measure available space and position accordingly
  }
  ...
  function positionPanel() {
    ...
    const panelW = Math.min(380, iframeW - 20);
    ...
    // Position vertically - prefer opening upward if more space, else downward
